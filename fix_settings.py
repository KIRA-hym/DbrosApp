...
with open(r'C:\dbros_app\lib\screens\settings_page.dart', 'r', encoding='utf-8') as f:
    code = f.read()
...
"""
    # Insert right before Widget _buildSettingsScrollBody
...
if body_match:
    ...
    code = code.replace(body_match.group(1), replacement)
...
old_methods = [
    ...
    r'  Widget _buildFloatingButtonSettings\(\) \{.*?(?=  Widget _buildScreenshotAuto|  Widget _buildProModeTestToggle)',
...
with open(r'C:\dbros_app\lib\screens\settings_page.dart', 'w', encoding='utf-8') as f:
    f.write(code)
