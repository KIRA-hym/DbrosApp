...
const originalCode = const { onDocumentCreated } = require('firebase-functions/v2/firestore');
...
exports.sendAdminPush = onDocumentCreated('admin_push_requests/{docId}', async (event) => { /* omitted for brevity */ });
...
fs.writeFileSync('C:/dbros_app/functions/index.js', originalCode, 'utf8');
