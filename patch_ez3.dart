...
void main() {
  ...
  // Look for the EXACT line       ); that closes Scaffold 1
  int s1Close = lines.indexWhere((l) => l == '      );', scaffold1Body); 
  // The line before that should be         ), which is the end of SafeArea
  ...
  // Look for the EXACT line       ), that closes Scaffold 2
  int s2Close = lines.indexWhere((l) => l == '      ),', scaffold2Body); 
  // The line before that should be         ), which is the end of ResponsiveBody
