...
void main() async {
  ...
  final endMarker = '  Widget _buildRecentLogSection() {';
  ...
  final newMethodsCode = '''  Widget _buildTodaySummaryCard() {
    ...
    final String dateFull = '\${workDay.year}??\${workDay.month}??\${workDay.day}??(\${DateFormat('E', 'ko').format(workDay)})';
                      ...
                      Expanded(
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                              '\${NumberFormat('#,###').format(statsProvider.todayExpenses)}??,
                              style: const TextStyle(
            ...
            child: Container(
              ...
              child: const Row(
                ...
                children: [
                  ...
                  SizedBox(width: 6),
                  Text('?湲곕퉬??怨꾩궛', style: TextStyle(color: Color(0xFFFFC700), fontWeight: FontWeight.bold, fontSize: 13)),
                ],
              ),
            ),
          ),
            ...
            child: Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text('二쇰? 肄쒕㏊', style: TextStyle(color: kMapFeaturesEnabled ? const Color(0xFFFFC700) : Colors.grey, fontWeight: FontWeight.bold, fontSize: 13)),
                ],
              ),
            ),
          ),
            ...
            child: Container(
              ...
              child: const Column(
                ...
                children: [
                  ...
                  SizedBox(height: 10),
                  Text('肄쒖뭅???④굔?깅줉', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 15)),
                ],
              ),
            ),
          ),
            ...
            child: Container(
              ...
              child: const Column(
                ...
                children: [
                  ...
                  SizedBox(height: 10),
                  Text('肄쒖뭅???ㅼ쨷?깅줉', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 15)),
                ],
              ),
            ),
          ),
