...
with open(r'C:\dbros_app\lib\screens\home_page.dart', 'r', encoding='utf-8') as f:
    content = f.read()

start_marker = '  Widget _buildTodaySummaryCard() {'
end_marker = '  Widget _buildUtilsRow() {'
...
new_code = """  Widget _buildTodaySummaryCard() {
...
with open(r'C:\dbros_app\lib\screens\home_page.dart', 'w', encoding='utf-8') as f:
    f.write(new_content)
